...
namespace Shader_Sample
{
    public class UV_Painter : MonoBehaviour
    {
        ...
        [SerializeField]private GameObject _paintObj;
        ...
        void Start() {
            _tex = new Texture2D(
                _paintObj.GetComponent<Renderer>().material.mainTexture.width,
                _paintObj.GetComponent<Renderer>().material.mainTexture.height
                );
            Graphics.CopyTexture(_paintObj.GetComponent<SpriteRenderer>().material.mainTexture, 0, 0, _tex, 0, 0);
        ...
        void Update() {
            ...
            if (Physics.Raycast(ray, out hit)) {
                Renderer renderer = hit.collider.gameObject.GetComponent<SpriteRenderer>();
